...
{
    const close = `<svg width="800px" height="800px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <title>Close</title>
    ...
    const diamond = `<svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return(
        <View style={{width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'center'}}>
            <View style={{width: '100%', height: 80, display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', alignItems: 'center'}}>
                <View style={{width: '90%', height: 50, display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
                    <PlatformPressable style={{width: '20%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'flex-start'}}>
                        <SvgXml xml={close} width="60%" height="60%"/>
                    </PlatformPressable>
                    <View style={{width: '60%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                        <Text style={{fontSize: 25, fontWeight: 'bold'}}>Subscription</Text>
                    </View>
                    <View style={{width: '20%', height: '100%'}}></View>
                </View>
            </View>
            <View style={{width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                <View style={{width:'100%', height: '60%', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                    <View style={{width:'100%', height: '20%', display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
                        <SvgXml xml={diamond} width="30" height="30"/>
                        <Text style={{fontSize: 20, fontWeight: 'bold', textAlign: 'center', width: 250}}>
                            Upgrade to Premium to unlock additional features
                        </Text>
                        <SvgXml xml={diamond} width="30" height="30"/>
                    </View>
                    <View style={{width:'70%', height: '40%', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                        <View style={{width:'100%', height: '60%', display: 'flex', flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'flex-end'}}>
                            <View style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
                                <LottieView
                                    source={require("./(tabs)/fast.json")}
                                    style={{width: "150%", height: "70%"}}
                                    autoPlay
                                    loop
                                    />
                                <Text style={{width: 100, textAlign: 'center'}}>Ultra Fast Connection</Text>
                            </View>
                        </View>
                        <View style={{width:'100%', height: '50%', display: 'flex', flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'flex-start'}}>
                            <View style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
                                <LottieView
                                    source={require("./(tabs)/uploading.json")}
                                    style={{width: "100%", height: "100%"}}
                                    autoPlay
                                    loop
                                    />
                                    <Text style={{width: 100, textAlign: 'center'}}>Migrate Grade Encription</Text>
                            </View>
                        </View>
                    </View>
                    <View style={{width:'100%', height: '40%', display: 'flex', flexDirection: 'column', alignItems: 'center', margin: 50}}>
                        <LottieView
                            source={require("./(tabs)/security.json")}
                            style={{width: "100%", height: "80%"}}
                            autoPlay
                            loop
                            />
                            <Text style={{width: 70, textAlign: 'center'}}>Virtual Location</Text>
                    </View>
                </View>
                <View style={{width:'70%', height: 60, borderRadius: 20, display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', backgroundColor: 'red', margin: 70}}>
                    <Text style={{fontSize: 20, fontWeight: 'bold', color: 'white'}}>7 Days Free Trial</Text>
                </View>
            </View>
        </View>
    );
